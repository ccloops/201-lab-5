...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var sumProd = multiply(multiply(a, b)[0], c)[0];
  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + sumThree + '.';
  var prodMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + sumProd + '.';
  return [sumThree, sumProd, sumMessage, prodMessage];
...
function sumArray(testArray){ //eslint-disable-line
  var arrayWeGo = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
  var arrayWeGoMessage = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + arrayWeGo + ' is their sum.';
  return [arrayWeGo, arrayWeGoMessage];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var arrayWeGo = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
  var arrayWeGoMessage = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of 24.';
  return [arrayWeGo, arrayWeGoMessage];
